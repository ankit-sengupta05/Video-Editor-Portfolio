...
const PRINCIPLES = [
  {
    num: '01',
    icon: (
      <svg width="26" height="26" fill="none" viewBox="0 0 24 24" stroke="var(--cyan)" strokeWidth="1.8">
  ...
  },
  {
    ...
    desc: 'Typography and motion graphics are built into the edit as a structural layer — not decoration. Kinetic energy is tuned to maximize audience retention and hook delivery.',
  },
];
...
export function Standard() {
  ...
  return (
    <section id="standard" className="section standard" ref={ref} aria-label="The Cyclops Standard">
      <motion.div className="standard__bg-text" style={{ y }} aria-hidden="true">
        CYCLOPS
      </motion.div>
